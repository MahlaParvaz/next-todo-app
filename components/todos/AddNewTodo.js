...
const TodoForm = ({ onAdd }) => {
    ...
    return (
      <div className="">
        <button
          ...
          className="w-full py-2 px-8 font-bold bg-blue-500 text-white rounded-lg 
  ...
  return (
    ...
    >
      <div className="mb-4">
        <label className="text-gray-600 mb-1 block" htmlFor="todo-list">
          Title
        </label>
        <input
          name="title"
      ...
      <div className="flex items-center gap-x-4">
        ...
        <button
          type="submit"
          className="w-full py-2  bg-blue-500 text-white border border-blue-500 rounded-lg transition-all duration-300 ease-in-out"
        >
          Add new todo
        </button>
      </div>
